...
Every application stores files on Google Drive. One central service handles all Drive operations — upload, download, folder organisation, authentication — across multiple accounts.

**Multiple account support:**
- Multiple Google Drive accounts registered in settings — add as many as needed
- Each account shows its used and available space in the dashboard
- System automatically routes new uploads to accounts with available space — no manual decision needed
- Optional: manually assign specific applications or channels to a specific account
- All accounts browseable from one place in the web app — one unified view regardless of which account the file is on

**Storage alerts:**
- Early warning when any account reaches 80% full — time to add a new account
- If an account fills up before a new one is added — uploads to that account pause, pending files queue, you get an immediate alert. Nothing lost.

**General behaviours:**
- Each application has its own organised folder structure on Drive
- Upload queue — if Drive is temporarily unavailable, files wait and upload when connection restores
- Server storage is temporary workspace only — files deleted from server immediately after upload to Drive
...
### Media Storage
- **Google Drive** as the media library
- Files stored in organised folders on Google Drive, separate folder structure per business
- App connects via Google Drive API to browse, select, and fetch assets
...
### AI Social Media Growth Assistant
- Analyzes posting history and patterns
- Suggests best times to post per platform
- Recommends content ideas based on trending topics in your niches
- Weekly performance summary via WhatsApp
- Ask anything: "How is my Facebook page doing?" / "What should I post this week?"
...
- [ ] Phase 2 — Application 1: Social Media Manager
  - Feature 1 — Social Media Posting & Scheduling
    ...
    - Smart queue + scheduling system
    - Special days calendar
    - AI growth assistant
  - Feature 2 — Competitor Monitoring & Product/Content Finding
    - Competitor tracker (FB Pages, Groups, IG, YT, TikTok, websites)
    - Competitor ad intelligence (Meta Ad Library, TikTok Ads Library)
    - Product catalog upload
    - Trend monitoring (Pinterest, Facebook, YouTube, Google)
    - Product/content suggestion engine
    - Web UI dashboard
